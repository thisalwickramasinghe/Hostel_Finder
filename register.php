              ...
              <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">Sign up</p>
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    ...
                    <input type="submit" value="Register" name="register" class="btn btn-warning btn-lg text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600; background-color: #003399; border-color:  #ffffff;" onmouseover="this.style.backgroundColor='#4da6ff'" onmouseout="this.style.backgroundColor='#003399'"/>

                    </div>

                  </form>
                  <p align="center">i have already account <a href="index.php" class="text-warning" style="font-weight:600; text-decoration:none; color: blue !important">Login</a></p>
                </div>
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                  <img src="signupfor.jpg" class="img-fluid" alt="Sample image" height="300px" width="500px">
